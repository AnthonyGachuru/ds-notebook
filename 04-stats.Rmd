...
Cohen's H | Cohen's D | Multiple comparisons Problem | Importance sampling | Bayes Error Rate | Pearson’s Coefficient of Skewness | Bayes factor | Correction methods for non representative samples | Mann–Whitney U test
...
[Mixed Categorical & Numeric Distance](https://www.rdocumentation.org/packages/StatMatch/versions/1.2.5/topics/gower.dist) | [2](https://www.rdocumentation.org/packages/ltm/versions/1.1-1/topics/biserial.cor)
...
Covariance: Measure of how two random values change together. Negative - variables show opposite behavior ( As A increases B decreases). Positive - variables show similar behavior (As A increases B increases). The Pearson Correlation is normalized version of covariance 
