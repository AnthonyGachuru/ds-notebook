...
Toolkit: classic ml bayesian ml rl ga & gp (symbolic regression) es gams statsmodels
...
Semi-supervised: active learning [Auto Labeling](https://blog.fastforwardlabs.com/2018/09/28/snorkel-rapid-training-data-creation-with-weak-supervision.html) https://machinelearningmastery.com/
...
[Sklearn Dsitributed ](https://alexperrier.github.io/jekyll/update/2016/03/16/out-of-core-scikit-boston-meetup.html#/)
...
https://pbiecek.github.io/breakDown/ [Break Down Plots](https://cran.r-project.org/web/packages/breakDown/index.html) http://clus.sourceforge.net/doku.php
...
[sklearn metrics](http://scikit-learn.org/stable/modules/model_evaluation.html#function-for-prediction-error-metrics) [Algorithm Comparison](https://docs.google.com/spreadsheets/d/16i47Wmjpj8k-mFRk-NnXXU5tmSQz8h37YxluDV8Zy9U/edit#gid=0) [Regression Effects Lib](https://www.rdocumentation.org/packages/yhat/versions/2.0-0)
...
https://christophm.github.io/interpretable-ml-book/shapley.html#the-general-idea
...
optuna: https://towardsdatascience.com/how-to-make-your-model-awesome-with-optuna-b56d490368af https://github.com/PiotrekGa/optuna_article/blob/master/Example.ipynb
...
Also known as Hierarchical or Mixed Effect Models. Good for dealing with longitudinal and/or nested data.
...
One suggestion in one of the links is to do PCA and then regress the original variables against the new axis. 
...
Spark uses Transformations & Actions for both RDD and dfs.
...
Dummying: The first step to encoding your categorical feature is to create a StringIndexer. Members of this class are Estimators that take a DataFrame with a column of strings and map each unique string to a number. Then, the Estimator returns a Transformer that takes a DataFrame, attaches the mapping to it as metadata, and returns a new DataFrame with a numeric column corresponding to the string column. The second step is to encode this numeric column as a one-hot vector using a OneHotEncoder. This works exactly #the same way as the StringIndexer by creating an Estimator and then a Transformer
...
[Kaggle Guide](https://t.co/Zcnd7EJKsn) [Chat Bots](https://rasa.ai/) [Doc Similarity](http://brandonrose.org/clustering) [Vector Embeddings](http://bookworm.benschmidt.org/posts/2015-10-25-Word-Embeddings.html)
...
[qdap](https://trinker.github.io/qdap/vignettes/qdap_vignette.html) [Web Devs](http://blog.algorithmia.com/natural-language-processing-algorithms-web-developers/) [Bot Makers](https://stanfy.com/blog/advanced-natural-language-processing-tools-for-bot-makers/) [NLP Intro](http://blog.algorithmia.com/introduction-natural-language-processing-nlp/)
...
https://www.stateoftheart.ai/ http://airesources.org/ https://alleninstitute.org http://allenai.org/index.html http://geometry.allenai.org/ https://competitions.codalab.org/competitions/20013 http://www.hbcse.tifr.res.in/jrmcont/notespart1/node27.html

[AI Music Generation](https://www.jukedeck.com) [AI Acheivements](https://poo.ai/) [Create With AI](http://createwith.ai/) [Playing Games](http://www.ggp.org/) [AI 4 Py](https://wiki.python.org/moin/PythonForArtificialIntelligence)
...
https://blog.openmined.org/upgrade-to-federated-learning-in-10-lines/ https://onnx.ai/onnx-r/
