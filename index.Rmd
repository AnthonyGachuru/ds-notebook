...
Another instantiation via Hadley Wickham is :  import -> tidy -> understand [ transform <-> visualize <-> model ] -> communicate
...
https://matrixds.com/ | https://www.crestle.com
...
ohort analysis, Transfer learning, cox proportional hazards, youden's j, Multiple Correspondence Analysis. platt scaling, generalized low rank models, conditional random field, linear probability model
