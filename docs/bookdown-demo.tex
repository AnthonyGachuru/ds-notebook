...
\tightlist
\item
  df \textless{}- dbGetQuery(con, statement = read\_file(`query.sql'))
\end{itemize}
...
\item
  Round a pandas time stamp to nearest minute: tstamp.round(`min')
\item
...
\chapter{Code Notes}\label{code-notes}
