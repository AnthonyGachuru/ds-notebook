...
Databricks \url{https://date.nager.at/} \url{https://runwayml.com/}
...
\section{Distributed}\label{distributed}}
...
\url{https://www.meltano.com/} \url{http://pachyderm.io} \url{https://datacoral.com/} Algorithmia \url{https://cloud.google.com/ai-platform/} \url{https://ropensci.org/technotes/2019/03/18/drake-700/} \href{https://www.wandb.com/blog/towards-reproducibility}{Weights \& Biases} Ansible \url{https://aws.amazon.com/sagemaker/} \url{https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/}
...
count data poisson n \textless{} 30
...
\url{https://tidyverts.github.io/tidy-forecasting-principles/}
...
posterior-p(model\textbar{}data) = likelihood-p(data\textbar{}model) * prior-p(model) / p(data)
...
Beaks cannot be of ``negative'' mean, therefore, HalfNormal is a reasonable, constrained prior.
