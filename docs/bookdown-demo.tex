...
\href{http://chrisalbon.com/}{Common Scripts} \url{https://distill.pub/} \url{https://pair-code.github.io/what-if-tool/} \url{https://nextjournal.com/} \url{https://paperswithcode.com/} \url{https://gitlab.com/meltano/meltano} \url{https://jdssv.org/index.php/jdssv} \url{https://rapids.ai/} \url{https://postersession.ai/}
