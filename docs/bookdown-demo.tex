...
\subsection{Maintain}\label{maintain}}
...
Modeling: sklearn mlxtend shap yellowbrick sspark, toolbox: classic ml, bayesian ml, abm, rl, ga \& gp: symbolic regression, es, fklearn
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# mixed effect regression}
\ImportTok{import}\NormalTok{ statsmodels.api }\ImportTok{as}\NormalTok{ sm}
\ImportTok{import}\NormalTok{ statsmodels.formula.api }\ImportTok{as}\NormalTok{ smf}
\NormalTok{mdl }\OperatorTok{=}\NormalTok{ smf.mixedlm(}\StringTok{"y ~ x1 + x2"}\NormalTok{. df, groups }\OperatorTok{=}\NormalTok{ train[}\StringTok{'group'}\NormalTok{])}
