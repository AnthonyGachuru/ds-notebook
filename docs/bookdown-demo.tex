...
\subsection{Supervised}\label{supervised}
...
\subsection{Probabilistic Programming}\label{probabilistic-programming}
...
\chapter{Time Series}\label{time-series-1}
...
\chapter{Deep Learning}\label{deep-learning-1}
...
\chapter{Probabilistic Programming}\label{probabilistic-programming-1}
...
\chapter{Causality}\label{causality-1}
