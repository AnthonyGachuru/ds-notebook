...
\href{http://jmcauley.ucsd.edu/data/amazon/}{Amazon Reviews} \textbar{} \href{http://saifmohammad.com/WebPages/NRC-Emotion-Lexicon.htm}{Word-Emotion Association Lexicon} \textbar{} \href{http://wordbank.stanford.edu/}{Word Bank} \textbar{} \href{http://www.lab41.org/nine-datasets-for-investigating-recommender-systems/}{Rec Systems} \textbar{} \href{http://www.esp.uem.es/jmgomez/smsspamcorpus/}{SMS Spam} \textbar{} \href{https://webrobots.io/kickstarter-datasets/}{Kickstarter \& Indiego Archive} \textbar{} \href{https://github.com/niderhoff/nlp-datasets/blob/master/README.md}{NLP} \textbar{} \href{https://summari.es}{Summarization Data} \textbar{} \href{http://lic.nlp.cornell.edu/nlvr/}{Visual Reasoning} \textbar{} \href{http://cjlab.stanford.edu/2015/09/30/lab-launch-and-data-sets/}{Journalism Data}

Open Census Data: \href{https://www.producthunt.com/posts/open-census-data}{1} \textbar{} \href{https://www.safegraph.com/open-census-data?ref=producthunt}{2} \textbar{} \href{https://docs.safegraph.com/docs/open-census-data}{3}

Causality: \href{https://www.kaggle.com/c/cause-effect-pairs}{1} \href{http://webdav.tuebingen.mpg.de/cause-effect/}{2}

Rosalind: \href{http://rosalind.info/problems/locations/}{1} \textbar{} \href{https://github.com/mtarbit/Rosalind-Problems}{2}

SEC: \href{https://www.sec.gov/structureddata}{1} \textbar{} \href{https://www.sec.gov/dera/data/financial-statement-and-notes-data-set.html}{2} \textbar{} \href{https://www.sec.gov/dera/data/financial-statement-data-sets.html}{3} \textbar{} \href{https://www.sec.gov/dera/data/financial-statement-data-sets.html}{4}

Neuro Data: \href{http://preprocessed-connectomes-project.org}{1} \textbar{} \href{http://www.humanconnectomeproject.org}{2} \textbar{} \href{http://fcon_1000.projects.nitrc.org/indi/abide/}{3} \textbar{} \href{https://www.ncbi.nlm.nih.gov/pubmed/25840117}{4} \textbar{} \href{https://coins.mrn.org}{5}

Time Series: \href{http://www2.stat.duke.edu/~mw/ts_data_sets.html}{1} \textbar{} \href{https://datamarket.com/data/list/?q=provider\%3Atsdl}{2} \textbar{} \href{https://archive.ics.uci.edu/ml/datasets.html?format=\&task=\&att=\&area=\&numAtt=\&numIns=\&type=ts\&sort=nameUp\&view=table}{3} \textbar{} \href{https://machinelearningmastery.com/challenging-machine-learning-time-series-forecasting-problems/}{4} \textbar{} \href{https://machinelearningmastery.com/challenging-machine-learning-time-series-forecasting-problems/}{5} \textbar{} \href{www.kaggle.com/c/demand-forecasting-kernels-only}{6} \textbar{} \href{https://www.kaggle.com/c/ams-2014-solar-energy-prediction-contes}{7} \textbar{} \href{https://www.kaggle.com/c/GEF2012-wind-forecasting}{8} \textbar{} \href{https://www.kaggle.com/c/web-traffic-time-series-forecasting}{9} \textbar{} \href{https://data.melbourne.vic.gov.au/Transport-Movement/Pedestrian-volume-updated-monthly-/b2ak-trbp}{sensor data} \textbar{} \href{https://date.nager.at/}{World Holidays}

Disney Animation: \href{https://blog.yiningkarlli.com/2018/07/disney-animation-datasets.html}{1} \textbar{} \href{https://www.disneyanimation.com/technology/datasets}{2}

NYC: \href{https://nycopendata.socrata.com/}{1} \textbar{} \href{https://health.data.ny.gov}{2} \textbar{} \href{http://www.nyc.gov/html/dot/html/about/datafeeds.shtml}{3}

Global: \href{http://datacatalogs.org/}{1} \textbar{} \href{http://index.okfn.org/place/}{2} \textbar{} \href{http://data.worldbank.org/}{3} \textbar{} \href{http://www.europeandataportal.eu/}{European Data Portal}

Sentiment: \href{http://ai.stanford.edu/~amaas/data/sentiment/}{1} \textbar{} \href{https://www.kaggle.com/c/sentiment-analysis-on-movie-reviews}{2}

Scripts: \href{https://www.springfieldspringfield.co.uk}{1} \textbar{} \href{https://github.com/BobAdamsEE/SouthParkData}{2} \textbar{} \href{http://www.cs.cornell.edu/~cristian/Cornell_Movie-Dialogs_Corpus.html}{3} \textbar{} \href{http://transcripts.foreverdreaming.org/viewtopic.php?f=809\&t=31120}{4}

Q \& A: \href{https://rajpurkar.github.io/SQuAD-explorer/}{1} \textbar{} \href{https://www.reddit.com/r/datasets/comments/1uyd0t/200000_jeopardy_questions_in_a_json_file/}{2} \textbar{} \href{http://jmcauley.ucsd.edu/data/amazon/qa/}{3} \textbar{} \href{http://ai2-website.s3.amazonaws.com/publications/algebra-TACL2015.pdf}{4} \textbar{} \href{http://quac.ai/}{5}

Autonomous Driving: \href{http://robotcar-dataset.robots.ox.ac.uk/}{1} \textbar{} \href{https://medium.com/udacity/open-sourcing-223gb-of-mountain-view-driving-data-f6b5593fbfa5\#.ch9a8c762}{2} \textbar{} \href{https://github.com/commaai/research}{3} \textbar{} \href{https://www.scaleapi.com/image-annotation/self-driving-cars}{4}

CV: \href{https://research.googleblog.com/2016/09/introducing-open-images-dataset.html}{1} \textbar{} \href{http://aloi.science.uva.nl/?__vid=5c0983704ebd0132821522000b2a88d7}{2} \textbar{} \href{http://www.vision.caltech.edu/visipedia/CUB-200.html?__vid=5c0983704ebd0132821522000b2a88d7}{3} \textbar{} \href{http://www.robots.ox.ac.uk/~vgg/data/flowers/17/?__vid=5c0983704ebd0132821522000b2a88d7}{4} \textbar{} \href{http://www.ee.surrey.ac.uk/CVSSP/demos/chars74k/}{5} \textbar{} \href{https://github.com/vc1492a/Hey-Waldo}{6} \textbar{} \href{https://github.com/gtoderici/sports-1m-dataset}{7}
...
\subsection{Distributed}\label{distributed}}
...
\subsubsection{sparklyr}\label{sparklyr}}
...
\hypertarget{unbalanced-classes}{%
...
\item
  Sklearn Eg: wclf = svm.SVC(kernel=`linear', class\_weight=\{1: 10\}) \& svm.SVC(kernel=`linear', class\_weight=`balanced')
\end{itemize}
...
\ImportTok{import}\NormalTok{ rpy2.robjects}
\ImportTok{from}\NormalTok{ rpy2.robjects }\ImportTok{import}\NormalTok{ r, pandas2ri}
\ImportTok{from}\NormalTok{ rpy2.robjects.packages }\ImportTok{import}\NormalTok{ importr}
\CommentTok{# base = importr('base') # not working for some weird issue}
\CommentTok{# %load_ext rpy2.ipython}
\NormalTok{stats }\OperatorTok{=}\NormalTok{ importr(}\StringTok{'stats'}\NormalTok{)}
\NormalTok{pandas2ri.activate()}
\NormalTok{r[}\StringTok{'mtcars'}\NormalTok{].head()}
\NormalTok{iris }\OperatorTok{=}\NormalTok{ pd.read_csv(}\StringTok{"https://bit.ly/2ow0oJO"}\NormalTok{)}
\NormalTok{test }\OperatorTok{=}\NormalTok{ iris.copy()}
\NormalTok{test.columns  }\OperatorTok{=}\NormalTok{ [}\StringTok{"Sepal.Length"}\NormalTok{, }\StringTok{"Sepal.Width"}\NormalTok{,  }\StringTok{"Petal.Length"}\NormalTok{, }\StringTok{"Petal.Width"}\NormalTok{, }\StringTok{"Species"}\NormalTok{]}
\NormalTok{rdf }\OperatorTok{=}\NormalTok{ pandas2ri.py2rpy_pandasdataframe(test)}
\NormalTok{rpy2.robjects.r(}\StringTok{'''}
\StringTok{f <- function() \{}
\StringTok{    model = load("rgr_iris.rda")}
\StringTok{    #predict(get(model), X)}
\StringTok{    return(get(model))}
\StringTok{    \}}
\StringTok{'''}\NormalTok{)}
\NormalTok{r_f }\OperatorTok{=}\NormalTok{ rpy2.robjects.r[}\StringTok{'f'}\NormalTok{]}
\NormalTok{mdl1 }\OperatorTok{=}\NormalTok{ r_f() }
\NormalTok{stats.predict(mdl1, test)}
\CommentTok{#----------------------------------------------------------}
\CommentTok{# %%R -i df -o model -w 5 -h 5 --units in -r 200}
\CommentTok{# import df from global environment}
\CommentTok{# make default figure size 5 by 5 inches with 200 dpi resolution}
\CommentTok{#library(ggplot2)}
\CommentTok{#library(stats)}
\CommentTok{#ggplot(df, aes(x=cups_of_coffee, y=productivity)) + geom_line()}
\CommentTok{#model =  lm("Petal.Length ~ . - Species", iris)}
\CommentTok{#----------------------------------------------------------}
\NormalTok{preds2 }\OperatorTok{=}\NormalTok{ stats.predict(model, test)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{not_in <-}\StringTok{ }\NormalTok{purrr}\OperatorTok{::}\KeywordTok{negate}\NormalTok{(}\OperatorTok{%in%}\NormalTok{)}
\NormalTok{not_between <-}\StringTok{ }\NormalTok{purrr}\OperatorTok{::}\KeywordTok{negate}\NormalTok{(between)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df_ebb <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{successes =} \KeywordTok{sum}\NormalTok{(success), }\DataTypeTok{sample_size =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_ebb_estimate}\NormalTok{(num_passed, sample_size)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df_fltrd }\OperatorTok{%>%}\StringTok{ }
\KeywordTok{select_if}\NormalTok{(is.numeric) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{cor}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\KeywordTok{corrplot}\NormalTok{(}\DataTypeTok{method =} \StringTok{"circle"}\NormalTok{, }\DataTypeTok{is.corr =} \OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{librarytidyverse}\ErrorTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# categorical comparison to target}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# https://stats.stackexchange.com/questions/798/calculating-optimal-number-of-bins-in-a-histogram/862#862}
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(x), }\DataTypeTok{binwidth =} \KeywordTok{diff}\NormalTok{(}\KeywordTok{range}\NormalTok{(x)) }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{2} \OperatorTok{*}\StringTok{ }\KeywordTok{IQR}\NormalTok{(x) }\OperatorTok{/}\StringTok{ }\KeywordTok{length}\NormalTok{(x)}\OperatorTok{^}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\DecValTok{3}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{sparklyr-1}{%
\section{Sparklyr}\label{sparklyr-1}}
...
\CommentTok{# subset by i calculate by j grouped using by}
\NormalTok{dt[i, j, by] }

\CommentTok{# prints last row}
\NormalTok{DT[.N] }

\CommentTok{# colnames}
\KeywordTok{names}\NormalTok{(DT)}
...
\NormalTok{dogs[, }\KeywordTok{lapply}\NormalTok{(.SD, mean), }\DataTypeTok{.SDcols =} \DecValTok{2}\OperatorTok{:}\DecValTok{3}\NormalTok{] }\CommentTok{# Find mean of columns 2 & 3}
