...
Beta for prior beta for posterior conjugate & binomial for likelihoood

Small alpha and beta means the prior is less informative 

Update: beta(alpha + successes, beta + failures)

mean beta: alpha/(alpha + beta)

mean beta posterior:  (alpha + successes)/(alpha + successes + beta + failures)
