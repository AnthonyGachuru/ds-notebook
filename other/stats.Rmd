...
Pmf prob mass function for a die p(1) = 1/6. Discrete rv
Pdf continuous rv
Can find quantiles (quartiles?) by setting cdf equal to percentage you want.
Indepent rvs are uncorrelated. That is Cor (X,Y)=0
Don’t sum sd’s. Not useful. Sum variances.
